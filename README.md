...
## Contact
+ Neeraj Yadav [n.yadav@se22.qmul.ac.uk](n.yadav@se22.qmul.ac.uk)

## The aim of this work
Using Machine Learning (ML) to use Electronic Health Records (EHRs) in such a way that we can:
...
Neural TPP models are integrated into an encoder-decoder architecture framework.
...
## Citation
Enguehard, J., Busbridge, D., Bozson, A.J., Woodcock, C. and Hammerla, N.Y. (2020). Neural Temporal Point Processes For Modelling Electronic Health Records. arXiv (Cornell University). doi:https://doi.org/10.48550/arxiv.2007.13794.
