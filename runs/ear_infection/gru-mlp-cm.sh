...
python scripts/train.py \
  ...
  --load-from-dir ~/neuralTPPs/data/synthea/split_1 \
  --plots-dir ~/neuralTPPs/plots/ear_infection_1/gru_mlp_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/ear_infection_2/gru_mlp_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/ear_infection_3/gru_mlp_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/ear_infection_4/gru_mlp_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
...
python scripts/train.py \
  ...
  --plots-dir ~/neural-tpps/plots/ear_infection_5/gru_mlp_cm \
  --time-scale 1e-5 \
  --save-model-freq 100 \
  --lr-rate-init 1e-2 \
  --lr-poisson-rate-init 1e-2 \
